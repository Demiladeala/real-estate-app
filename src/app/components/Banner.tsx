...
const Banner = (props: Props) => {
  return (
    <div className='relative w-[90%] mx-auto my-20 px-4 py-4 md:py-20 md:mt-24 mb-8 bg-white box-shadow rounded-2xl'>
        ...
        <div>
            ...
            <button className='relative text-white mt-4 px-4 py-2 rounded-xl flex gap-4 items-center font-semibold bg-[#222] hover:opacity-95'>
                <p>Get A Quote</p>
